...
| Skill | Description |
|-------|-------------|
| [duckyai-cli](duckyai-cli/) | DUCKYAI CLI for orchestrator configuration, worker management, and vault updates |
...
- [DUCKYAI](https://github.com/jykim/DUCKYAI) - Full PKM automation framework
- [DUCKYAI Docs](https://jykim.github.io/DUCKYAI/) - Documentation and guides
- [Discord Community](https://discord.gg/58cmahcbx3) - Join the discussion

## DUCKYAI Framework

These skills are part of the [DUCKYAI](https://github.com/jykim/DUCKYAI) framework for AI-powered personal knowledge management. For the complete automation system including workflows, templates, and integrations, check out the main project.
