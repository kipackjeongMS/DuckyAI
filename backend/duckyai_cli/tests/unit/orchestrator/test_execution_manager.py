...
from duckyai_cli.orchestrator.models import AgentDefinition, ExecutionContext
...
class TestExecutionManager:
    ...
    @patch('duckyai_cli.orchestrator.execution_manager.CLAUDE_CLI_PATH', '/mock/claude')
