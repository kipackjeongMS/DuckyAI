...
from duckyai_cli.orchestrator.agent_registry import AgentRegistry
from duckyai_cli.orchestrator.execution_manager import ExecutionManager
from duckyai_cli.orchestrator.models import AgentDefinition
...
""", encoding='utf-8')
    ...
    def test_pattern_removal_from_markdown_utils(self):
        ...
        from duckyai_cli.markdown_utils import remove_pattern_from_content
