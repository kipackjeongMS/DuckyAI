...
This folder contains canonical agent definitions for the DUCKYAI orchestrator system. Each file defines an agent's behavior, input/output specifications, and processing logic.
...
- **Examples**:
  ```yaml
  input_path: 00-Inbox        # Single path
...
- **Examples**: `03-Knowledge/Documentation`, `_Settings_/Tasks`
...
**Behavior**:
- Agent triggers immediately when new file appears in `00-Inbox/`
- Creates new file in `03-Knowledge/Documentation/` with processed content
...
1. **Be Specific About Input**
   - File location: "Files in `00-Inbox/`"
...
2. **Define Clear Output**
   - File location: "Creates file in `03-Knowledge/Documentation/`"
...
## Output
- File: `04-Periodic/Daily/{YYYY-MM-DD} - Daily Roundup.md`
