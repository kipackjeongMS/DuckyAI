...
from duckyai.main import doctor as doctor_module
from duckyai.main import install_health
...
def test_doctor_command_reports_json(monkeypatch):
    monkeypatch.setattr(
        ...
        lambda source_dir=None: {
            ...
            "repair_pth": "C:/Python314/Lib/site-packages/duckyai_repo.pth",
...
def test_doctor_command_repairs_install(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(doctor_module, "repair_source_install", lambda source: tmp_path / "site-packages" / "duckyai_repo.pth")
    monkeypatch.setattr(
        doctor_module,
        "collect_install_diagnostics",
        lambda source_dir=None: {
