...
AGENT_SCHEMA = {
    ...
    "properties": {
        ...
        "executor": {"enum": ["copilot_cli", "claude_code", "copilot_sdk", "agency"]},
...
class AgentRegistry:
        ...
        for file_path in sorted(self.agents_dir.glob("*.md")):
            try:
                ...
                agent = AgentDefinition(
                    ...
                    trigger_wait_for=trigger_wait_for,
                    require_parent_output=bool(frontmatter.get('require_parent_output', False)),
                    input_path=input_path,
    ...
    def _load_agent(self, file_path: Path, node: dict, agent_id: str) -> Optional[AgentDefinition]:
        ...
        agent = AgentDefinition(
            ...
            trigger_wait_for=trigger_wait_for,
            require_parent_output=node.get('require_parent_output', False),
            cron=cron,
            input_path=input_path,
