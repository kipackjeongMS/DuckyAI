...
- `03-Knowledge/Topics/` folder (auto-detect recently modified files)
- Maximum 5 topics per run

## Output

- `{{output_path}}/YYYY-MM-DD Daily Research Briefing - [Agent].md`
- Default output_path: `03-Knowledge/Documentation`

## Workflow

### Step 1: Identify Active Topics

Scan `03-Knowledge/Topics/` folder for recently modified files (last 7 days):

```bash
# Find recently modified topic files
find 03-Knowledge/Topics/ -name "*.md" -mtime -7 | sort -t/ -k2
```
