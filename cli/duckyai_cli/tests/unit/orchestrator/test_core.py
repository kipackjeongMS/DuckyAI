...
from duckyai_cli.orchestrator.core import Orchestrator
from duckyai_cli.orchestrator.models import AgentDefinition, TriggerEvent
...
"""
    ...
    @patch('duckyai_cli.orchestrator.core.ExecutionManager.execute')
    @patch('duckyai_cli.orchestrator.core.ExecutionManager.can_execute')
