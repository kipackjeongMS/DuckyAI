...
```markdown
✅ CORRECT: [[04-Periodic/Daily/2025-10-31]]
...
❌ INCORRECT: [[03-Knowledge/Topics/Career#Skill Development]]
...
✅ Link to file only: [[04-Periodic/Daily/2025-10-31]]
❌ Don't guess: [[04-Periodic/Daily/2025-10-31#Guessed Header]]
```
...
```markdown
For specific file:
- Use Glob with full path pattern: "04-Periodic/Daily/2025-10-31.md"
...
### 04-Periodic/Daily/Daily Files
```markdown
Path: 04-Periodic/Daily/YYYY-MM-DD.md
Format: [[04-Periodic/Daily/YYYY-MM-DD]]
...
Validation:
1. Check file: 04-Periodic/Daily/YYYY-MM-DD.md
2. Read file content
...
Validation:
1. Use Glob: "03-Knowledge/Topics/**/*{keyword}*.md"
