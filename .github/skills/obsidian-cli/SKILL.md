...
- **`path=<path>`** — Exact path from vault root. No searching, just direct access.
  - Example: `obsidian read path="04-Periodic/Daily/2026-02-28.md"` (exact path required)
...
# Mixed
obsidian create path="04-Periodic/Daily/2026-02-28.md" content="Daily note" --open
```
...
# Read by path
obsidian read path="04-Periodic/Daily/2026-02-28.md"
...
# With exact path
obsidian create path="04-Periodic/Daily/2026-02-28.md" content="..." --overwrite
```
...
# Move with new name
obsidian move path="04-Periodic/Daily/old.md" to="Archive/2025-old.md"
```
...
```bash
# Show task at line 5 in 04-Periodic/Daily/2026-02-28.md
obsidian task ref="04-Periodic/Daily/2026-02-28.md:5"

# Toggle task status
obsidian task ref="04-Periodic/Daily/2026-02-28.md:5" --toggle

# Mark as done
obsidian task ref="04-Periodic/Daily/2026-02-28.md:5" --done

# Mark as incomplete
obsidian task ref="04-Periodic/Daily/2026-02-28.md:5" --todo
...
```bash
# Bookmark a file
obsidian bookmark file="04-Periodic/Daily/2026-02-28.md"
...
# By path
obsidian history path="04-Periodic/Daily/2026-02-28.md"
```
...
```bash
obsidian tab:open file="04-Periodic/Daily/2026-02-28.md"
